...
function heroMotion(){
    var tl = gsap.timeline({scrollTrigger:{trigger:"#spaces", markers:false, scrub:true, end: "bottom 45%", start: "top 60%"}})
        ...
        .from("#people", { duration:1,scale:2.5, color: "black"},"-=1")
...
function galleryMotion(){
    var tl= gsap.timeline({scrollTrigger:{trigger:"#gallery-1", scrub:true, markers:true, end: "center center", start: "center bottom"}});
     tl.from("#gallery-1", {duration: 3, clipPath: "inset(100%)",alpha: 0})
       .from("#gallery-5", {duration: 3,clipPath: "inset(100%)",alpha: 0 },"-=1.5")
       .from("#gallery-2", {duration: 3,clipPath: "inset(100%)",alpha: 0 },"-=1.5")
       .from("#gallery-4", {duration: 3,clipPath: "inset(100%)",alpha: 0 },"-=1.5")
       .from("#gallery-3", {duration: 3,clipPath: "inset(100%)",alpha: 0 },)
       .from("#gallery-6", {duration: 3,clipPath: "inset(100%)",alpha: 0 })
       .from("#gallery-7", {duration: 3,clipPath: "inset(0 50%)", color: "black" }, "-=8");
       return tl
}
...
//        .from("#gallery-7", {duration: 3, alpha: 1 }, "+=8");
//        return tl
// }

// function galleryMotion(){
//      var tl= gsap.timeline({scrollTrigger:{trigger:"#gallery-1", scrub:true, markers:true, end: "center 40%", start: "center bottom"}});
